...
## input
proj_fp=/mnt/chunyu6tb/sunbeam/Lewis2015/sunbeam_output
data_fp=${proj_fp}/qc/decontam
...
for sample in ${samples}; do
  ...
  $gnu_time_fp -v \
   run_midas.py species ${midas_fp}/${sample} \
    -d $midas_db -t 1 -1 ${data_fp}/${sample}_1.fastq.gz -2 ${data_fp}/${sample}_2.fastq.gz \
