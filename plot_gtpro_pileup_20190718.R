...
## Output argument
plot_file <- args[3] ## str(CLASSIFY_FP/'gtpro-r1'/'biplot_20190715'/'{genome}'/'{sample}_gp.pdf'),
output_file <- args[4] ## str(CLASSIFY_FP/'gtpro-r1'/'biplot_20190715'/'{genome}'/'{sample}_gp.tsv'),
stats_file <- args[5] ## str(CLASSIFY_FP/'gtpro-r1'/'biplot_20190715'/'{genome}'/'{sample}_stats.csv')
corr_by_genome_file <- args[6] ## str(CLASSIFY_FP/'gtpro-r1'/'biplot_20190715'/'{genome}'/'{sample}_bygenome_corr.csv')
jc_by_genome_file <- args[7] ## str(CLASSIFY_FP/'gtpro-r1'/'biplot_20190715'/'{genome}'/'{sample}_bygenome_jc.csv')
